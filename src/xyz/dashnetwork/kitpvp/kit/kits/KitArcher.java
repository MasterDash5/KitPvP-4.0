...
public class KitArcher extends Kit {
    ...
    public KitEquipment setupEquipment() {
        ...
        ItemStack helmet = new ItemMaker(Material.CHAINMAIL_HELMET).enchant(Enchantment.PROTECTION_ENVIRONMENTAL, 4).unbreakable().build();
        ItemStack chestplate = new ItemMaker(Material.CHAINMAIL_CHESTPLATE).enchant(Enchantment.PROTECTION_ENVIRONMENTAL, 4).unbreakable().build();
        ItemStack leggings = new ItemMaker(Material.CHAINMAIL_LEGGINGS).enchant(Enchantment.PROTECTION_ENVIRONMENTAL, 4).unbreakable().build();
        ItemStack boots = new ItemMaker(Material.CHAINMAIL_BOOTS).enchant(Enchantment.PROTECTION_ENVIRONMENTAL, 4).unbreakable().build();
