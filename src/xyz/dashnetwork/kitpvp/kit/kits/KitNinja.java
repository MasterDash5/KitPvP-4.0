...
public class KitNinja extends Kit {
    ...
    public KitEquipment setupEquipment() {
        ...
        ItemStack shuriken = new ItemMaker(Material.NETHER_STAR).name("&fShuriken").enchant(Enchantment.DAMAGE_ALL, 1).flags(ItemFlag.HIDE_ENCHANTS).build();
        ...
        return new KitEquipment(weapon, shuriken, helmet, chestplate, leggings, boots, Collections.singletonList(new PotionEffect(PotionEffectType.SPEED, Integer.MAX_VALUE, 1, false, false)), null);
    }
}